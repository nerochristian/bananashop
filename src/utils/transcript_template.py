...
HTML_TEMPLATE = r"""<!--
Generated by RUSH EXCHANGES
https://rushexch.org | https://discord.gg/rushexch
-->
...
<head>
    <title>Rush Exchanges - {channel_name}</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width" />
    <meta name="title" content="Rush Exchanges - {channel_name}">
    <meta name="description" content="Transcript of channel {channel_name} ({channel_id}) from Rush Exchanges ({guild_id}) with {message_count} messages. This transcript was generated on {generated_at} (UTC).">
    <meta name="theme-color" content="#638dfc" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Rush Exchanges - {channel_name}" />
    <meta property="og:description" content="Transcript of channel {channel_name} ({channel_id}) from Rush Exchanges ({guild_id}) with {message_count} messages. This transcript was generated on {generated_at} (UTC)." />

    <!-- Twitter -->
    <meta name="twitter:card" content="summary" />
    <meta name='twitter:title' content="Rush Exchanges - {channel_name}" />
    <meta name='twitter:description' content="Transcript of channel {channel_name} ({channel_id}) from Rush Exchanges ({guild_id}) with {message_count} messages. This transcript was generated on {generated_at} (UTC)." />
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.15.6/build/styles/solarized-dark.min.css">
...
<div class="main">
    ...
    <div class="info">
        ...
        <span class="info__subject">This is the start of the #{channel_name} channel. </span>
    </div>
...
<div class="footer">
    <span class="footer__text">This transcript was generated on {generated_at} (UTC)</span>
</div>
...
<div id="summary-popout" class="summary-popout">
    <div class="meta__header">
         <img src="{guild_icon}" alt="Avatar">
    </div>
    <div class="meta__description">
        <div class="meta__details">
            <div class="meta__user">{guild_name}</div>
        </div>
        ...
        <div class="meta__field">
            ...
            <div class="meta__value">{created_at}</div>
        </div>
        <div class="meta__field">
        ...
        <div class="meta__field">
            ...
            <div class="meta__value">{participant_count}</div>
        </div>
    ...
    tippy('.unix-timestamp', {
        ...
        theme: 'disc',
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                const longFmt = new Intl.DateTimeFormat([], {
                    dateStyle: "full",
                    timeStyle: "medium"
                });
                ...
                document.querySelectorAll(".chatlog__timestamp").forEach(ts => {
                    const raw = ts.getAttribute("data-timestamp");
                    if (!raw) return;
                    ...
                    if (!isNaN(parsed)) {
                        ...
                        ts.textContent = formatter.format(date);
                        ...
                        ts.setAttribute("title", longFormatter.format(date));
                    }
                });
                ...
                document.querySelectorAll(".info, .meta__value").forEach(el => {
                    const txt = el.textContent.trim();

                    const m = txt.match(/([A-Za-z]{3} \d{1,2}, \d{4}) \((\d{2}:\d{2}:\d{2})\)/);
                    if (!m) return;

                    const combined = `${m[1]} ${m[2]} UTC`;
                    const date = new Date(combined);
                    if (isNaN(date.getTime())) return;

                    el.textContent = shortFmt.format(date) + " (" + date.toLocaleTimeString() + ")";
                });

                const footer = document.querySelector(".footer__text");
                if (footer) {
                    const ft = footer.textContent.trim();

                    const fm = ft.match(/on (.*) \(UTC\)/);
                    if (fm) {
                        const rawFooter = fm[1];

                        const parsed = new Date(rawFooter.replace(" at ", " ") + " UTC");

                        if (!isNaN(parsed.getTime())) {
                            footer.textContent =
                                "This transcript was generated on " +
                                longFmt.format(parsed);
                        }
                    }
                }
            });
