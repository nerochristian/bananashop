...
# Since Config might not be available or structured differently, we'll define a simple config default or import if available
# The user code imported Config, but I don't see it in the file list. I'll rely on constants or defaults.
...
class WelcomeCardOptions:
    ...
    avatar_size: int = 196
    margin: int = 28
    accent_color: int = Colors.PRIMARY # Use bot's primary color
    server_name: str = "Roblox Keys"
